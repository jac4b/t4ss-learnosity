...
<div class="jumbotron section index">
    <div class="section-intro">
        ...
        <ul>
            ...
            <li><a class="blue-chevron" href="#data-reporting">Using granular, back-end data reporting</a></li>
        </ul>
        </p>
    </div>
</div>
<div class="section index">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Display Student-Centric Reports</h3>
                </div>
                <div class="panel-body">
                    <p>Learn more about individual students in an easy, in-depth fashion!</p>
                    <p class="text-right">
                        <a class="demo_link"  href="https://demos.learnosity.com/analytics/student-centric-reporting.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Present Classroom & Teacher-Centric Reports</h3>
                </div>
                <div class="panel-body">
                    <p>Monitor and compare your students at a glance.</p>
                    <p class="text-right">
                        <a class="demo_link"  href="https://demos.learnosity.com/analytics/teacher-centric-reporting.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Show Coursework Progress</h3>
                </div>
                <div class="panel-body">
                    ...
                    <p class="text-right">
                        <a class="demo_link"  href="https://demos.learnosity.com/analytics/progress-centric-reporting.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Display Large-Scale Group/District Reports</h3>
                </div>
                <div class="panel-body">
                    <p>Discover large-scale group reporting and let Learnosity take care of the heavy lifting.</p>
                    <p class="text-right">
                        <a class="demo_link"  href="https://demos.learnosity.com/analytics/group-reporting.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Response Analysis Reporting</h3>
                </div>
                <div class="panel-body">
                    <p>Summarize class responses at a glance. Group students based on their strengths and needs.</p>
                    <p class="text-right">
                        <a class="demo_link"  href="https://demos.learnosity.com/analytics/response-analysis-reporting.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p class="text-right">
                        <a class="demo_link"  href="https://demos.learnosity.com/analytics/outcomes-mastery-reporting.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Provide Live Progress Tracking & Control</h3>
                </div>
                <div class="panel-body">
                    <p>Allow your instructors to see student progress through tests in real-time, along with instructor and teacher control.</p>
                    <p class="text-right">
                        <a class="demo_link"  href="https://demos.learnosity.com/analytics/live-progress-reporting.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
...
<div class="section index">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Disable Reporting UI to Work Directly with Data</h3>
                </div>
                <div class="panel-body">
                    ...
                    <p class="text-right">
                        <a class="demo_link"  href="https://demos.learnosity.com/analytics/no-ui-reports.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Use click events</h3>
                </div>
                <div class="panel-body">
                    <p>Bring our reports to life, by integrating click behavior and adding an extra depth to your reporting.</p>
                    <p class="text-right">
                        <a class="demo_link"  href="https://demos.learnosity.com/analytics/reports-click-events.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
...
<div class="section index">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">View Data API Examples</h3>
                </div>
                <div class="panel-body">
                    <p>Sometimes, you just need access to all the raw info you can handle! Using Learnosity's Data API, you can.</p>
                    <p class="text-right">
                        <a class="demo_link"  href="https://demos.learnosity.com/analytics/data/index.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
