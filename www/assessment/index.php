        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p class="text-right">
                        <a class="demo_link" href="https://demos.learnosity.com/assessment/activities.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p class="text-right">
                        <a class="demo_link" href="https://demos.learnosity.com/assessment/inline.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p class="text-right">
                        <a class="demo_link" href="https://demos.learnosity.com/assessment/assess.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p class="text-right">
                        <a class="demo_link" href="https://demos.learnosity.com/assessment/branching.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p class="text-right">
                        <a class="demo_link" href="https://demos.learnosity.com/assessment/adaptive.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p class="text-right">
                        <a class="demo_link" href="https://demos.learnosity.com/assessment/testlet-adaptive.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p class="text-right">
                        <a class="demo_link" href="https://demos.learnosity.com/assessment/sections.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p class="text-right">
                        <a class="demo_link" href="https://demos.learnosity.com/assessment/try-again.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p class="text-right">
                        <a class="demo_link" href="https://demos.learnosity.com/assessment/stem-assessment.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
...
<div class="section index">
    <h2 id="customizing">Customizing Behaviour</h2>
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p class="text-right">
                        <a class="demo_link" href="https://demos.learnosity.com/assessment/accessibility.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p class="text-right">
                        <a class="demo_link" href="https://demos.learnosity.com/assessment/worked-solutions.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p class="text-right">
                        <a class="demo_link" href="https://demos.learnosity.com/assessment/distractor-rationale.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p class="text-right">
                        <a class="demo_link" href="https://demos.learnosity.com/assessment/reading_time.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p class="text-right">
                        <a class="demo_link" href="https://demos.learnosity.com/assessment/locking-questions.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p class="text-right">
                        <a class="demo_link" href="https://demos.learnosity.com/assessment/restrict-responses.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p class="text-right">
                        <a class="demo_link" href="https://demos.learnosity.com/assessment/question-indexing.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p class="text-right">
                        <a class="demo_link" href="https://demos.learnosity.com/assessment/audio-advanced.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p class="text-right">
                        <a class="demo_link" href="https://demos.learnosity.com/assessment/formulamathjaxcdn.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p class="text-right">
                        <a class="demo_link" href="https://demos.learnosity.com/assessment/regions.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p class="text-right">
                        <a class="demo_link" href="https://demos.learnosity.com/assessment/events.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p class="text-right">
                        <a class="demo_link" href="https://demos.learnosity.com/assessment/annotations.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p class="text-right">
                        <a class="demo_link" href="https://demos.learnosity.com/assessment/rtl.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p class="text-right">
                        <a class="demo_link" href="https://demos.learnosity.com/assessment/failed-submission.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p class="text-right">
                        <a class="demo_link" href="https://demos.learnosity.com/assessment/activities-i18n.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <p class="text-right">
                        <a class="demo_link" href="https://demos.learnosity.com/assessment/reset-response.php">Demo</a>
                    </p>
                </div>
            </div>
        </div>
